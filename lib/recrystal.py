...
def scale_to(points, newRadius, direction=0):
	...
	c = newRadius/radius
	print "diameter=%f, c=%f" %(radius, c)

	points = points*c

	return points

#Replaced with a fortran function that does the same thing (goldfcc.goldfcc.fcc_cube(n,l,4*n**3))
"""
def fcc_cube(n,l):
...
def main():
	...
	goldbox = goldfcc.goldfcc.fcc_cube(n, 4.0782,4*n**3)
	coord = [a for a in goldbox]
